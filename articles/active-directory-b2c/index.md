...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="/opsacndocsdemo/active-directory-b2c/active-directory-b2c-overview">
        <div class="cardSize">
    ...
    <li>
        <a href="/opsacndocsdemo/active-directory-b2c/active-directory-b2c-get-started">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/active-directory-b2c/active-directory-b2c-devquickstarts-ios">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/active-directory-b2c/active-directory-b2c-devquickstarts-android">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/active-directory-b2c/active-directory-b2c-devquickstarts-api-node">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/active-directory-b2c/active-directory-b2c-devquickstarts-web-dotnet">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/active-directory-b2c/active-directory-b2c-devquickstarts-api-dotnet">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/active-directory-b2c/active-directory-b2c-devquickstarts-native-dotnet">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
