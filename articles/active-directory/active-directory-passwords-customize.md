---
title: Customize: Azure Active Directory password management | Azure
...
In order to give your users the best possible experience, we recommend that you explore and play with all of the password management configuration options available to you. In fact, you can start exploring this right away by going to the configuration tab of the **Active Directory extension** in the [Azure Classic Management Portal](https://manage.windowsazure.cn). This topic walks you through all of the different password management customizations you can make as an administrator from within **Configure** tab of your directory within the [Azure Classic Management Portal](https://manage.windowsazure.cn).
...
<table>
            ...
            <tr>
              ...
              <td>
                ...
                <br>
                <p><b><u>Requires one of the following licenses <a href="./active-directory-passwords.md#pricing-and-availability">learn more</a></u></b></p>
                 <ul>
            ...
            <tr>
             ...
             <tr>
              ...
              <td>
                ...
                <ul>
                  <li class="unordered">
                    In order to use this feature, you must install the August 2015 or later release of Azure AD Connect (v. 1.0.8667.0 or greater).<br><br><a href="http://www.microsoft.com/zh-cn/download/details.aspx?id=47594">Click here to download the latest version of Azure AD Connect.</a></li>
                  <li class="unordered">
