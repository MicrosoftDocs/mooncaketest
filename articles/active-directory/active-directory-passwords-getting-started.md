---
title: Getting Started: Azure AD Password management | Azure
...
- [Azure AD Password Reset: Documentation Table of Contents](./active-directory-passwords.md)
...
- [General password reset licensing information](./active-directory-passwords-customize.md#what-customization-options-are-available)
- [Per-feature password reset licensing information](./active-directory-passwords.md#pricing-and-availability)
- [Scenarios supported for password writeback](./active-directory-passwords-learn-more.md#scenarios-supported-for-password-writeback)
...
- [Deploying password reset without requiring users to register](./active-directory-passwords-learn-more.md#deploying-password-reset-without-requiring-end-user-registration)
- [What data is used by password reset](./active-directory-passwords-learn-more.md#what-data-is-used-by-password-reset)
...
- [Troubleshoot: password writeback](./active-directory-passwords-troubleshoot.md#troubleshoot-password-writeback)
- [Writeback event log error codes](./active-directory-passwords-troubleshoot.md#password-writeback-event-log-error-codes)
- [Troubleshoot: password writeback connectivity](./active-directory-passwords-troubleshoot.md#troubleshoot-password-writeback-connectivity)
...
- [Information to include when you need help](./active-directory-passwords-troubleshoot.md#information-to-include-when-you-need-help)
...
- Create an AAD tenant. For more information, see [Getting Started with Azure AD](./index.md)
...
- Upgrade to Azure AD Premium, Basic, or use an O365 paid license. For more information, see [Azure Active Directory Editions](https://www.azure.cn/pricing/details/identity/).
...
1. Open a browser of your choice and go to the [Azure Classic Management Portal](https://manage.windowsazure.cn).
2. In the [Azure Classic Management Portal](https://manage.windowsazure.cn), find the **Active Directory extension** on the navigation bar on the left hand side.
...
> [!NOTE]
> You can disable Password Writeback at any time by either re-running this wizard and deselecting the feature, or by setting the **Write Passwords Back to On-Premises Directory** setting to **No** in the **User Password Reset Policy** section of your directory’s **Configure** tab in the [Azure Classic Management Portal](https://manage.windowsazure.cn).  For more information about customizing your password reset experience, check out [Customize: Azure AD Password Management](./active-directory-passwords-customize.md).
>
>
