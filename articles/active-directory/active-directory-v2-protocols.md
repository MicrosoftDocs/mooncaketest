---
title: Azure AD v2.0 Protocols | Azure
...
| `8eaef023-2b34-4da1-9baa-8bc8c9d6a490` or `contoso.partner.onmschina.cn` |Allows only users with work/school accounts from a particular Azure Active Directory tenant to sign into the application.  Either the friendly domain name of the Azure AD tenant or the tenant's guid identifier can be used. |
