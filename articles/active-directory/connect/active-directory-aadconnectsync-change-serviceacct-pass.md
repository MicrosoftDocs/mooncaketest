...
- If you try to start the Synchronization Service in Windows Service Control Manager, you receive the error "**Windows could not start the Azure AD Sync service on Local Computer**". **Error 1069: The service did not start due to a logon failure.**"
...
3. Navigate to folder: `$env:Program Files\Azure AD Sync\bin\`
...
2. Select **Azure AD Sync** and click Restart.
