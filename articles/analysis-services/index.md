...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="/opsacndocsdemo/analysis-services/analysis-services-overview">
        <div class="cardSize">
    ...
    <li>
        <a href="/opsacndocsdemo/analysis-services/analysis-services-create-server">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
...
<ul class="panelContent cardsW">
    ...
                    <div class="cardText">
                        <h3>Command-Line</h3>
                        <p><a href="/opsacndocsdemo/analysis-services/analysis-services-powershell">PowerShell</a></p>
                    </div>
                </div>
            </div>
        </div>
