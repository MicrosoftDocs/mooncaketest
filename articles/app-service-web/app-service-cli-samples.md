...
| [Bind a custom SSL certificate to a web app](./scripts/app-service-cli-configure-ssl-certificate.md)| Creates an Azure web app and binds the SSL certificate of a custom domain name to it. |
|**Scale app**||
...
| [Scale a web app nationwide with a high-availability architecture](./scripts/app-service-cli-scale-high-availability.md) | Creates two Azure web apps in two different geographical regions and makes them available through a single endpoint using Azure Traffic Manager. |
...
| [Connect a web app to a redis cache](./scripts/app-service-cli-app-service-redis.md) | Creates an Azure web app and a redis cache, then adds the redis connection details to the app settings.) |
| [Connect a web app to a documentdb](./scripts/app-service-cli-app-service-documentdb.md) | Creates an Azure web app and a documentdb, then adds the documentdb connection details to the app settings. |
|**Monitor app**||
