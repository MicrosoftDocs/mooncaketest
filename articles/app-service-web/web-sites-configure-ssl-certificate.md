---
title: Secure your app's custom domain with HTTPS | Azure
...
so your clients can already access your app at **https://*&lt;appname>*.chinacloudsites.cn**. But if you want to use 
...
> [!NOTE]
> You can get help from Azure experts anytime on the [Azure forums](https://www.azure.cn/support/forums/). 
> For more personalized support, go to [Azure Support](https://www.azure.cn/support/contact/) and 
> click **Get Support**.
> 
> 
...
1. Navigate to the Kudu debug console for your app. Its address is `https://<appname>.scm.chinacloudsites.cn/DebugConsole`.
