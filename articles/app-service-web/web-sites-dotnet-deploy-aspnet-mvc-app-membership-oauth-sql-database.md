...
4. Click **OK**.
5. The **Configure Azure Web App Settings** dialog appears. You may need to sign in if you have not already done so, or reenter your credentials if your login is expired.
...
This tutorial was written by [Rick Anderson](http://blogs.msdn.com/b/rickandy/) with assistance from Tom Dykstra and Barry Dorrans. 
