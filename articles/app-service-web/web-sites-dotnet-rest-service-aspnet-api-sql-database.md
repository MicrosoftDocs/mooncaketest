---
title: Create a REST API in Azure with ASP.NET and SQL DB | Azure
...
<!-- the next line produces the "Set up the development environment" section as see at /azure/web-sites-dotnet-get-started/ -->
