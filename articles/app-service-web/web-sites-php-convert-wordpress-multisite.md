...
The **Free** [App Service](/azure/app-service-web/app-service-changes-existing-services/) plan mode does not support adding custom domains to Web Apps. You will need to switch to **Shared** or **Standard** mode. To do this:
