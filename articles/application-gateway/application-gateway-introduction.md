---
title: Introduction to Application Gateway | Azure
...
You can create and manage an application gateway by using REST APIs, PowerShell cmdlets, Azure CLI, or [Azure portal preview](https://portal.azure.cn/).
