...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="/opsacndocsdemo/application-insights/app-insights-overview">
        <div class="cardSize">
    ...
    <li>
        <a href="/opsacndocsdemo/application-insights/app-insights-azure-web-apps">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/application-insights/app-insights-asp-net">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/application-insights/app-insights-java-get-started">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
  ...
  <li>
        <a href="/opsacndocsdemo/application-insights/app-insights-nodejs">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
