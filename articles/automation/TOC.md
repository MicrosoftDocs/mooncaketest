...
### [在数据中心运行 Runbook](automation-hybrid-runbook-worker.md)
### [配置 Runbook 输入参数](automation-runbook-input-parameters.md)
### [在图形 Runbook 中处理时出错](automation-runbook-graphical-error-handling.md)
...
### [源代码管理与 GitHub Enterprise 集成](automation-scenario-source-control-integration-with-github-ent.md)
## 监视
### [将 Azure 自动化作业数据转发到 Log Analytics](automation-manage-send-joblogs-log-analytics.md)
### [从 Log Analytics 断开 Azure 自动化帐户的链接](automation-unlink-from-log-analytics.md)
## 迁移
...
### [排除混合 Runbook 辅助角色的故障](automation-troubleshooting-hybrid-runbook-worker.md)
# 引用
...
## [价格](https://azure.microsoft.com/pricing/details/automation/)  
## [MSDN 论坛](https://social.msdn.microsoft.com/Forums/azure/zh-CN/home?forum=azureautomation)  
...
## [Azure 自动化培训](https://mva.microsoft.com/zh-CN/training-courses/automating-the-cloud-with-azure-automation-8323?l=C6mIpCay_4804984382)
