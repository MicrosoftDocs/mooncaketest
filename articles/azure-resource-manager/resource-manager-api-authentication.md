...
Because your app accesses other subscription, you must configure it as a multi-tenant application. To pass validation, provide a domain associated with your Active Directory. To see the domains associated with your Active Directory, log in to the [Classic Management Portal](https://manage.windowsazure.cn). Select your Active Directory and then select **Domains**.
