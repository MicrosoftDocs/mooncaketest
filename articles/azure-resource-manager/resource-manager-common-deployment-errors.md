---
title: Troubleshoot common Azure deployment errors | Azure
...
- Syntax error
    ...
    When you receive this type of error, carefully review the expression syntax. Consider using a JSON editor like [Visual Studio](./vs-azure-tools-resource-groups-deployment-projects-create-deploy.md) or [Visual Studio Code](/documentation/articles/resource-manager-vs-code/), which can warn you about syntax errors.
...
### <a id="storagenamenotunique" name="storageaccountalreadyexists-and-storageaccountalreadytaken"></a> StorageAccountAlreadyExists and StorageAccountAlreadyTaken
...
If you deploy a template that creates more than four cores in the China North region, you get a deployment error that looks like:
...
| Storage |[Monitor, diagnose, and troubleshoot Azure Storage](../storage/storage-monitoring-diagnosing-troubleshooting.md) |
