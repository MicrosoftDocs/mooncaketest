...
When you decide to decompose your template design into multiple nested templates, the following guidelines help standardize the design. The recommended design consists of the following templates:
