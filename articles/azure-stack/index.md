...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="/opsacndocsdemo/azure-stack/azure-stack-poc">
        <div class="cardSize">
    ...
    <li>
        <a href="/opsacndocsdemo/azure-stack/azure-stack-run-powershell-script"> 
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/azure-stack/azure-stack-provision-vm">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
