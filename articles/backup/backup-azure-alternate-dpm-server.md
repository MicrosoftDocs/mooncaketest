---
title: Recovering data from another Azure Backup Server in the backup vault | Azure
...
> [!NOTE] 
> This article and the following steps are also applicable to [System Center Data Protection Manager UR7](https://support.microsoft.com/zh-cn/kb/3065246) with the [latest Azure Backup agent](http://aka.ms/azurebackup_agent).
>
>
