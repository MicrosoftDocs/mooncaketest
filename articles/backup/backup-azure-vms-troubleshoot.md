...
1. WhiteList the Azure datacenter IP ranges.
   - Get the list of [Azure datacenter IPs](https://www.microsoft.com/en-us/download/details.aspx?id=41653) to be whitelisted.
