---
title: Back up a Windows server or client to Azure using the classic deployment model | Azure
...
1. Sign in to [the Classic Management Portal](https://manage.windowsazure.cn/).
...
5. Click **Create Vault**.
    ...
    It can take a while for the backup vault to be created. To check the status, monitor the notifications at the bottom of the Classic Management Portal.
