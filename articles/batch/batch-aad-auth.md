...
// /documentation/articles/active-directory-integrating-applications/
...
Next, you'll need to delegate access to your application to the Azure Resource Manager API. The Azure AD identifier for the Resource Manager API is **Azure Service Management API**.
...
5. In step 1, enter **Azure Service Management API**, select that API from the list of results, and click the **Select** button.
...
Before you can authenticate via Azure AD from your Batch application, you need to register your application with Azure AD and grant access to the Batch service API. The Azure AD identifier for the Batch service API is **Azure Batch (MicrosoftAzureBatch)**.
...
4. In step 1, search for **MicrosoftAzureBatch**, select **Azure Batch (MicrosoftAzureBatch)**, and click the **Select** button.
