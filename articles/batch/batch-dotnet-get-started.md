---
title: 教程 - 使用适用于 .NET 的 Azure Batch 客户端库 | Azure
...
> [!TIP]
> [How to use Blob Storage from .NET](../storage/storage-dotnet-how-to-use-blobs.md) 对如何使用 Azure 存储容器和 blob 进行了很好的概述。开始使用 Batch 时，它应位于阅读列表顶部附近。
>
>
