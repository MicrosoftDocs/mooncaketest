---
title: 运行并行任务以最大化节点使用量 - Azure Batch | Azure
...
为了说明并行执行任务的好处，试举一例：用户的任务应用程序具有特定的 CPU 和内存要求，根据该要求，节点大小为 [Standard\_D1](../cloud-services/cloud-services-sizes-specs.md) 已足够，但若要在所需时间内完成作业，则需使用 1,000 个这样的节点。
