...
that balances the load evenly. The [Data partitioning guidance document](http://msdn.microsoft.com/zh-cn/library/dn589795.aspx)
...
[Data consistency primer](http://msdn.microsoft.com/zh-cn/library/dn589800.aspx) page on the Microsoft website.
...
> Redis does not guarantee that all writes will be saved in the event
  ...
  appropriate data store. For more information, see the [cache-aside pattern](http://msdn.microsoft.com/zh-cn/library/dn589799.aspx).
...
- [Cache-aside pattern](http://msdn.microsoft.com/zh-cn/library/dn589799.aspx): This pattern describes how to load data on demand into a cache from a data store. This pattern also helps to maintain consistency between data that's held in the cache and the data in the original data store.
- The [Sharding pattern](http://msdn.microsoft.com/zh-cn/library/dn589797.aspx) provides information about implementing horizontal partitioning to help improve scalability when storing and accessing large volumes of data.
...
- The [Azure Redis Cache documentation](./cache/index.md) page on the Microsoft website
- The [Azure Redis Cache FAQ](./redis-cache/cache-faq.md) page on the Microsoft website
- The [Configuration model](http://msdn.microsoft.com/zh-cn/library/windowsazure/hh914149.aspx) page on the Microsoft website
