...
4. To confirm that the role instances are running, in the [management portal](https://manage.windowsazure.cn), click **Cloud Services** > *your_cloud_service_name* > **Instances**.
