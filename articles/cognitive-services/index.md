...
<ul class="panelContent cardsFTitle">
    ...
    <li>
        <a href="/opsacndocsdemo/cognitive-services/cognitive-services-text-analytics-quick-start">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
     ...
     <li>
        <a href="/opsacndocsdemo/cognitive-services/cognitive-services-recommendations-quick-start">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
