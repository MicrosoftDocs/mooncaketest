...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="/opsacndocsdemo/container-registry/container-registry-intro">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Learn about Azure Container Registry</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <a href="/opsacndocsdemo/container-registry/container-registry-get-started-portal">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/container-registry/container-registry-get-started-azure-cli">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
...
<ul class="panelContent cardsW">
    ...
                    <div class="cardText">
                        <h3>Command-Line</h3>
                        <p><a href="/cli/opsacndocsdemo/acr">Azure CLI</a></p>
                    </div>
                </div>
            </div>
        </div>
