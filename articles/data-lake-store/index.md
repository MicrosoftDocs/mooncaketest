...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="/opsacndocsdemo/data-lake-store/data-lake-store-overview">
        <div class="cardSize">
   ...
   <li>
    ...
    <li>
        <a href="/opsacndocsdemo/data-lake-store/data-lake-store-get-started-portal">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
     ...
     <li>
        <a href="/opsacndocsdemo/data-lake-store/data-lake-store-get-started-powershell">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
     ...
     <li>
        <a href="/opsacndocsdemo/data-lake-store/data-lake-store-get-started-cli">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/data-lake-store/data-lake-store-get-started-net-sdk">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/data-lake-store/data-lake-store-get-started-java-sdk">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
     ...
     <li>
        <a href="/opsacndocsdemo/data-lake-store/data-lake-store-manage-use-nodejs">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
