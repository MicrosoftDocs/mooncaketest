...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="/opsacndocsdemo/devtest-lab/devtest-lab-overview">
        <div class="cardSize">
    ...
    <li>
        <a href="/opsacndocsdemo/devtest-lab/devtest-lab-create-lab">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/devtest-lab/devtest-lab-add-vm-with-artifacts">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/devtest-lab/devtest-lab-training-lab">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
