...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="/opsacndocsdemo/dns/dns-overview">
        <div class="cardSize">
    ...
    <li>
        <a href="/opsacndocsdemo/dns/dns-getstarted-create-dnszone-portal">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/dns/dns-getstarted-create-dnszone">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
     ...
     <li>
        <a href="/opsacndocsdemo/dns/dns-getstarted-create-recordset">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
