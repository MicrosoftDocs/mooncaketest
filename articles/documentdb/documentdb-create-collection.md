---
title: Create a DocumentDB database and collection | Azure
description: Learn how to create NoSQL databases and JSON document collections using the online service portal for Azure DocumentDB, a cloud based document database. Get a trial today.
services: documentdb
author: mimig1
manager: jhubbard
editor: monicar
...
To use Azure DocumentDB, you must have a [DocumentDB account](./documentdb-create-account.md), a database, a collection, and documents. This topic describes how to create a DocumentDB collection in the Azure portal.

Not sure what a collection is? See [What is a DocumentDB collection?](#what-is-a-documentdb-collection)

1. In the [Azure portal](https://portal.azure.cn/), in the Jumpbar, click **DocumentDB (NoSQL)**, and then in the **DocumentDB (NoSQL)** blade, select the account in which to add a collection. If you don't have any accounts listed, you'll need to [create a DocumentDB account](./documentdb-create-account.md).
...
- For a REST API sample, see [Create a Collection](https://msdn.microsoft.com/zh-cn/library/azure/mt489078.aspx).
