---
title: Deploy a web app with a template - Azure DocumentDB | Azure
...
This tutorial shows you how to use an Azure Resource Manager template to deploy and integrate [Azure DocumentDB](https://www.azure.cn/home/features/documentdb/), an [Azure App Service](../app-service-web/app-service-changes-existing-services.md) web app, and a sample web application.
...
- An Azure subscription. Azure is a subscription-based platform.  For more information about obtaining a subscription, see [Trial](https://www.azure.cn/pricing/1rmb-trial/).
...
10. Feel free to continue exploring the Azure Portal, or follow one of our DocumentDB [samples](./documentdb-dotnet-samples.md) to create your own DocumentDB application.
...
- For a guide to the change of the old portal to the new portal see: [Reference for navigating the Azure Classic Management Portal](../app-service-web/app-service-web-app-azure-portal.md)
