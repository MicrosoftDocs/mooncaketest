---
title: Manage a DocumentDB account via the Azure Portal | Azure
...
1. In the [Azure portal](https://portal.azure.cn/), access your DocumentDB account.
...
In the [Azure portal](https://portal.azure.cn/), access the **Keys** blade from the resource menu on the **DocumentDB account** blade to view, copy, and regenerate the access keys that are used to access your DocumentDB account.
...
2. Regenerate the primary access key for your DocumentDB account. In the [Azure Portal](https://portal.azure.cn/),
...
1. In the [Azure portal](https://portal.azure.cn/), access the DocumentDB account you wish to delete.
...
Learn how to [get started with your DocumentDB account](./documentdb-get-started-quickstart.md).
