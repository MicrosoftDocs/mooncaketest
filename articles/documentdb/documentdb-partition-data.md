---
title: Partitioning and scaling in Azure DocumentDB | Azure
...
## Partition keys <a name="partition-keys"></a>
...
Azure DocumentDB added support for automatic partitioning with [REST API version 2015-12-16](https://msdn.microsoft.com/zh-cn/library/azure/dn781481.aspx). In order to create partitioned collections, you must download SDK versions 1.6.0 or newer in one of the supported SDK platforms (.NET, Node.js, Java, Python). 
...
## Migrating from single-partition to partitioned collections in DocumentDB <a name="migrating-from-single-partition"></a>
...
## Designing for partitioning <a name="designing-for-partitioning"></a>
