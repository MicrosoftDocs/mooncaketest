---
title: DocumentDB programming: Stored procedures, database triggers, and UDFs | Azure
...
keywords: Database triggers, stored procedure, stored procedure, database program, sproc, documentdb, azure, Azure
services: documentdb
documentationcenter: ''
author: aliuy
manager: jhubbard
...
The creation and execution of database triggers, stored procedure and custom query operators is supported through the [REST API](https://msdn.microsoft.com/zh-cn/library/azure/dn781481.aspx), [DocumentDB Studio](https://github.com/mingaliu/DocumentDBStudio/releases), and [client SDKs](./documentdb-sdk-dotnet.md) in many platforms including .NET, Node.js and JavaScript.
...
This sample shows how to use the [.NET SDK](https://msdn.microsoft.com/zh-cn/library/azure/dn948556.aspx) to create a pre-trigger and create a document with the trigger enabled. 
...
- [Azure DocumentDB SDKs](https://msdn.microsoft.com/zh-cn/library/azure/dn781482.aspx)
