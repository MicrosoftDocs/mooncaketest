---
title: Create and modify an ExpressRoute circuit: PowerShell: Azure Resource Manager | Azure
...
To begin your configuration, sign in to your Azure account. For more information about PowerShell, see [Using Windows PowerShell with Resource Manager](../azure-resource-manager/powershell-azure-resource-manager.md). Use the following examples to help you connect:
