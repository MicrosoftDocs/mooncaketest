...
> [!NOTE]
> While ExpressRoute circuit is prefered over Site-to-Site VPN when both routes are the same, Azure will use the longuest prefix match to choose the route towards the packet's destination.
> 
> 
