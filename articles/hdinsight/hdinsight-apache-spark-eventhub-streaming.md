---
title: Stream data from Event Hubs with Apache Spark in Azure HDInsight | Azure
...
> [!NOTE]
> To follow the instructions in this article, you will have to use both versions of the Azure portal preview. To create an Event Hub you will use the [Azure Classic Management Portal](https://manage.windowsazure.cn). To work with the HDInsight Spark cluster, you will use the [Azure Portal Preview](https://portal.azure.cn/).  
> 
> 
...
1. From the [Azure Portal Preview](https://manage.windowsazure.cn), select **NEW** > **Service Bus** > **Event Hub** > **Custom Create**.
