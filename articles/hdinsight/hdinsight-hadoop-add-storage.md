---
title: Add additional Azure storage accounts to HDInsight | Azure
...
1. In a web browser, open the Ambari Web UI for your HDInsight cluster. The URI is https://CLUSTERNAME.azurehdinsight.cn. Replace __CLUSTERNAME__ with the name of your cluster.
