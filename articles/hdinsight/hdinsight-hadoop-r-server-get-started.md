...
## Prerequisites
* **An Azure subscription**: Before you begin this tutorial, you must have an Azure subscription. Go to [Get a Azure trial](https://www.azure.cn/pricing/1rmb-trial/) for more information.
