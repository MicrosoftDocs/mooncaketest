...
* HDInsight Tools for Visual Studio - 参阅[开始使用 HDInsight Tools for Visual Studio](./hdinsight-hadoop-visual-studio-tools-get-started.md) 安装并配置 HDInsight Tools for Visual Studio。
