...
#### [创建和部署 blink 应用程序](iot-hub-raspberry-pi-kit-node-lesson1-deploy-blink-app.md)
### 第 2 课：创建 IoT 中心
...
#### [创建和部署 blink 应用程序](iot-hub-intel-edison-kit-node-lesson1-deploy-blink-app.md)
### 第 2 课：创建 IoT 中心
...
#### [创建和部署 blink 应用程序](iot-hub-intel-edison-kit-c-lesson1-deploy-blink-app.md)
### 第 2 课：创建 IoT 中心
...
##### [创建 IoT 中心和注册设备](iot-hub-gateway-kit-c-lesson2-register-device.md)
...
## [为 Node.js 使用直接方法](iot-hub-node-node-direct-methods.md)
## [为 .NET/Node 使用直接方法](iot-hub-csharp-node-direct-methods.md)
## [Node.js 设备管理入门](iot-hub-node-node-device-management-get-started.md)
## [.NET/Node 设备管理入门](iot-hub-csharp-node-device-management-get-started.md)
## [如何使用孪生属性 \(Node\)](iot-hub-node-node-twin-how-to-configure.md)
## [如何使用孪生属性 \(.NET/Node\)](iot-hub-csharp-node-twin-how-to-configure.md)
...
## [MSDN 论坛](https://social.msdn.microsoft.com/Forums/azure/zh-CN/home?forum=azureiothub)
