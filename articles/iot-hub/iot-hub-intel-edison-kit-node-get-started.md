---
title: Connect Intel Edison (Node) to Azure IoT - Get Started | Azure
...
Go to [Create your IoT hub and register Intel Edison](./iot-hub-intel-edison-kit-node-lesson2-prepare-azure-iot-hub.md).
