...
The domain label for the public IP address that the load balancer uses for this deployment model is \<cloud service name\>.chinacloudapp.cn. The following graphic shows the Azure Load Balancer in this model.
