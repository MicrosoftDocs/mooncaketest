...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="/opsacndocsdemo/logic-apps/logic-apps-what-are-logic-apps">
        <div class="cardSize">
    ...
    <li>
        <a href="/opsacndocsdemo/logic-apps/logic-apps-create-a-logic-app">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/logic-apps/logic-apps-arm-provision">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/opsacndocsdemo/logic-apps/logic-apps-create-api-app">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Schemas</h3>
                        <p><a href="/opsacndocsdemo/logic-apps/logic-apps-workflow-definition-language">Workflow definition language</a></p>
                        <p><a href="/opsacndocsdemo/logic-apps/logic-apps-workflow-actions-triggers">Workflow actions and triggers</a></p>
                   </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/opsacndocsdemo/logic-apps/logic-apps-schema-2016-04-01">GA</a></p>
                        <p><a href="/opsacndocsdemo/logic-apps/logic-apps-schema-2015-08-01">Preview</a></p>
                   </div>
                </div>
            </div>
        </div>
