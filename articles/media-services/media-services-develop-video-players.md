...
For information about closed captioning and ads support in Live streaming videos, see [Supported Closed Captioning and Ad Insertion Standards](./media-services-manage-channels-overview.md#closed-captioning-and-ad-insertion).
