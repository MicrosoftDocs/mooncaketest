---
title: Protect HLS content with Microsoft PlayReady or Apple FairPlay - Azure | Azure
...
- The following are required when using AMS to deliver HLS encrypted with FairPlay and to deliver FairPlay licenses.
    ...
    - An Azure account. For details, see [Azure Trial](https://www.azure.cn/pricing/1rmb-trial/?WT.mc_id=A261C142F).
