...
When you are ready to deploy to Azure, recompile for deployment to the cloud, deploy to Azure, and run http://*your_hosted_name*.chinacloudapp.cn/TwilioCloud/callform.jsp in the browser (substitute your value for *your_hosted_name*).
