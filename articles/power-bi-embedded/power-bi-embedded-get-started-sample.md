...
- [Power BI Embedded API reference](https://msdn.microsoft.com/zh-cn/library/mt711493.aspx)
- [Power BI Embedded .NET SDK ](https://www.nuget.org/profiles/powerbi) (available via NuGet)
