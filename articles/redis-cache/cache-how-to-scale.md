...
In addition to scaling your Azure Redis Cache instances in the Azure portal preview, you can scale using Azure Redis Cache PowerShell cmdlets, Azure CLI, and by using the Azure Management Libraries (MAML). 
