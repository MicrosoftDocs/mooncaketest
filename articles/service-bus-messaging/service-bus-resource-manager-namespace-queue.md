---
title: Create a Service Bus namespace with queue using an Azure Resource Manager template | Azure
...
>-    [Create a Service Bus namespace ](./service-bus-resource-manager-namespace-topic.md)
