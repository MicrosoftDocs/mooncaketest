...
Fix common problems in application upgrades by referring to the steps in [Troubleshooting Application Upgrade](./service-fabric-application-upgrade-troubleshooting.md)
