---
title: 在 C# 中创建第一个可靠的 Azure 微服务 | Azure
...
Azure Service Fabric 应用程序包含运行你的代码的一个或多个服务。本指南说明如何使用 [Reliable Services](./service-fabric-reliable-services-introduction.md) 同时创建无状态与有状态的 Service Fabric 应用程序。此微软虚拟学院视频还说明如何创建无状态可靠服务：
...
>[!NOTE]
> 在运行应用程序之前，请确保有本地开发群集正在运行。有关设置本地环境的信息，请查看[入门指南](./service-fabric-get-started.md)。
