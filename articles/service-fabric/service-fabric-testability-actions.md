---
title: Simulate failures in Azure microservices | Azure
...
###<a id="run-an-action-against-a-one-box-cluster"></a> Run an action against a one-box cluster
...
###<a id="run-an-action-against-an-azure-cluster"></a> Run an action against an Azure cluster
