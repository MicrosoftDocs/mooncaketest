---
title: Fail back VMware virtual machines and physical servers to the on-premises site | Azure
...
5. If you have selected a *classic deployment* network - you will be asked to create a new VM via the Azure gallery and install the process sever in it.
    ...
    2. Install the Process server as per the steps [given here](/documentation/articles/site-recovery-vmware-to-azure-classicz/#step-5-install-the-management-server)
...
6. If you select the *Resource Manager* Azure network, you will need to give the following inputs to deploy the server.
    ...
    5. Choose the specific Subnet and the Network Interface to connect to it. Note - you need to create your own [Network interface](/documentation/articles//virtual-networks-multiple-nics) (NIC) and select it while deploying.
