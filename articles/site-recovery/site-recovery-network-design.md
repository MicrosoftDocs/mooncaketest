...
[Learn](/documentation/articles/site-recovery-network-mapping/) how Site Recovery maps source and target networks when a VMM server is being used to manage the primary site.