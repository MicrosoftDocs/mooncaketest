---
title: Replicate VMware VMs and physical servers to Azure in the classic portal | Azure
...
##<a id="scenario-architecture"></a> Scenario architecture
...
##<a id="before-you-start-deployment"></a> Before you start deployment
...
##<a id="step-3:-download-a-vault-registration-key"></a> Step 4: Download a vault registration key
...
##<a id="step-5-install-the-management-server"></a> Step 5: Install the management server
> [!TIP]
...
##<a id="step-6-set-up-credentials-for-the-vcenter-server"></a> Step 6: Set up credentials for the vCenter server
...
##<a id="step-7-add-vcenter-servers-and-esxi-hosts"></a> Step 7: Add vCenter servers and ESXi hosts
...
##<a id="step-8-create-a-protection-group"></a> Step 8: Create a protection group
...
##<a id="deploy-additional-process-servers"></a> Deploy additional process servers
...
##<a id="vmware-permissions-for-vcenter-access"></a> VMware permissions for vCenter access
