...
**Load:** The ability to ingest data into the service. Loads are best performed with PolyBase from Azure Storage Blobs. This metric is designed to stress network and CPU aspects of the service.
