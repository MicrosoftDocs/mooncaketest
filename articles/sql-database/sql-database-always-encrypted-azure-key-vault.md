...
- Use the Always Encrypted wizard in SSMS to create [Always Encrypted Keys](https://msdn.microsoft.com/zh-cn/library/mt163865.aspx#Anchor_3)
    - Create a [Column Master Key (CMK)](https://msdn.microsoft.com/zh-cn/library/mt146393.aspx).
    - Create a [Column Encryption Key (CEK)](https://msdn.microsoft.com/zh-cn/library/mt146372.aspx).
...
- [SQL Server Management Studio (SSMS)](https://msdn.microsoft.com/zh-cn/library/mt238290.aspx) version 13.0.700.242 or later.
- [.NET Framework 4.6](https://msdn.microsoft.com/zh-cn/library/w0x726c2.aspx) or later (on the client computer).
...
1. Open the [Classic portal](http://manage.windowsazure.cn).
...
12. Leave **SHOW** set to **Microsoft Apps** and then locate and select **Azure Service Management** and click the check-mark to continue.
13. On the **Azure Service Mana...** line click the **Delegated Permissions** dropdown and select **Access Azure Service Management**.
...
3. **Column Selection**
    ...
    Click **Next** on the **Introduction** page to open the **Column Selection** page where you select which columns you want to encrypt, [the type of encryption, and what column encryption key (CEK)](https://msdn.microsoft.com/zh-cn/library/mt459280.aspx#Anchor_2) to use.
...
> [!IMPORTANT]
> Your application must use [SqlParameter](https://msdn.microsoft.com/zh-cn/library/system.data.sqlclient.sqlparameter.aspx) objects when passing plaintext data to the server with Always Encrypted columns. Passing literal values without using SqlParameter objects will result in an exception.
...
You can set this directly in the connection string, or you can set it using a [SqlConnectionStringBuilder](https://msdn.microsoft.com/zh-cn/library/system.data.sqlclient.sqlconnectionstringbuilder.aspx). The sample application in the next section shows how to use the **SqlConnectionStringBuilder**.
...
The following code shows how to enable Always Encrypted by setting the [SqlConnectionStringBuilder.ColumnEncryptionSetting](https://msdn.microsoft.com/zh-cn/library/system.data.sqlclient.sqlconnectionstringbuilder.columnencryptionsetting.aspx) to [Enabled](https://msdn.microsoft.com/zh-cn/library/system.data.sqlclient.sqlconnectioncolumnencryptionsetting.aspx).
...
- [Rotate and cleanup your Keys](https://msdn.microsoft.com/zh-cn/library/mt607048.aspx).
- [Migrate data that is already encrypted with Always Encrypted](https://msdn.microsoft.com/zh-cn/library/mt621539.aspx)

## Related Information

- [Always Encrypted (client Development)](https://msdn.microsoft.com/zh-cn/library/mt147923.aspx)
- [Transparent Data Encryption](https://msdn.microsoft.com/zh-cn/library/bb934049.aspx)
- [SQL Server Encryption](https://msdn.microsoft.com/zh-cn/library/bb510663.aspx)
- [Always Encrypted Wizard](https://msdn.microsoft.com/zh-cn/library/mt459280.aspx)
