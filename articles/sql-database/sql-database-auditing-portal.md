...
* Through the [Azure Portal](https://portal.azure.cn) - open the relevant database. At the top of the database's Auditing & Threat detection blade, click on **View audit logs**.
