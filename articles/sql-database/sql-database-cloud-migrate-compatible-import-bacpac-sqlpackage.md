...
description: Azure SQL Database, database migration, import database, import BACPAC file, sqlpackage
...
Use the following steps to use the [SqlPackage.exe](https://msdn.microsoft.com/zh-cn/library/hh550080.aspx) command line utility to import a compatible SQL Server database (or Azure SQL database) from a BACPAC file.
