...
* **An Azure account**. You can [open a 1rmb Azure account](https://www.azure.cn/pricing/1rmb-trial/).
...
- For pricing information, see [Azure SQL Database pricing](https://www.azure.cn/pricing/details/sql-database/).