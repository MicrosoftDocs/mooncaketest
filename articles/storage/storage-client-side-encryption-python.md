---
title: Client-Side Encryption with Python for Azure Storage | Microsoft Docs
...
# Client-Side Encryption with Python for Azure Storage
...
The storage client library expects the provided KEK and key resolver to implement the following interface. [Azure Key Vault](https://www.azure.cn/home/features/key-vault/) support for Python KEK management is pending and will be integrated into this library when completed.
