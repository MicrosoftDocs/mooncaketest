---
title: Configure a connection string for Azure Storage | Azure
...
You can use the [Azure Configuration Manager](https://www.nuget.org/packages/Microsoft.WindowsAzure.ConfigurationManager/) to access your connection string at runtime regardless of where your application is running.
...
> [!TIP]
> You can find your storage account's connection strings in the [Azure portal preview](https://portal.azure.cn). Navigate to **SETTINGS** > **Access keys** in your storage account's menu blade to see connection strings for both primary and secondary access keys.
>
