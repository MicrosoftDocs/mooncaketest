...
If you are familiar with Windows performance monitoring, you can think of Storage Metrics as being an Azure Storage equivalent of Windows Performance Monitor counters. In Storage Metrics you will find a comprehensive set of metrics (counters in Windows Performance Monitor terminology) such as service availability, total number of requests to service, or percentage of successful requests to service (for a full list of the available metrics, see [Storage Analytics Metrics Table Schema](http://msdn.microsoft.com/zh-cn/library/azure/hh343264.aspx). You can specify whether you want the storage service to collect and aggregate metrics every hour or every minute. For more information about how to enable metrics and monitor your storage accounts, see [Enabling storage metrics and viewing metrics data](http://msdn.microsoft.com/zh-cn/library/dn782843.aspx).

You can choose which hourly metrics you want to display in the [Azure Portal](https://portal.azure.cn) and configure rules that notify administrators by email whenever an hourly metric exceeds a particular threshold. For more information, see [Receive Alert Notifications](../monitoring-and-diagnostics/insights-receive-alert-notifications.md).
...
- [Common REST API Error Codes](http://msdn.microsoft.com/zh-cn/library/azure/dd179357.aspx)
- [Blob Service Error Codes](http://msdn.microsoft.com/zh-cn/library/azure/dd179439.aspx)
- [Queue Service Error Codes](http://msdn.microsoft.com/zh-cn/library/azure/dd179446.aspx)
- [Table Service Error Codes](http://msdn.microsoft.com/zh-cn/library/azure/dd179438.aspx)
- [File Service Error Codes](https://msdn.microsoft.com/zh-cn/library/azure/dn690119.aspx)
...
To work around the JavaScript issue, you can configure Cross Origin Resource Sharing (CORS) for the storage service the client is accessing. For more information, see [Cross-Origin Resource Sharing (CORS) Support for Azure Storage Services](http://msdn.microsoft.com/zh-cn/library/azure/dn535601.aspx).
...
You can find a list of common REST API error codes that the storage services return on the page [Common REST API Error Codes](http://msdn.microsoft.com/zh-cn/library/azure/dd179357.aspx).
...
For more information about the Microsoft Message Analyzer **Web Proxy** trace, see [Microsoft-PEF-WebProxy Provider](http://technet.microsoft.com/zh-cn/library/jj674814.aspx).
...
For more information about the Microsoft Message Analyzer Local Link Layer trace, see [Microsoft-PEF-NDIS-PacketCapture Provider](http://technet.microsoft.com/zh-cn/library/jj659264.aspx).

### <a name="appendix-4"></a>Appendix 4: Using Excel to view metrics and log data

Many tools enable you to download the Storage Metrics data from Azure table storage in a delimited format that makes it easy to load the data into Excel for viewing and analysis. Storage Logging data from Azure blob storage is already in a delimited format that you can load into Excel. However, you will need to add appropriate column headings based in the information at [Storage Analytics Log Format](http://msdn.microsoft.com/zh-cn/library/azure/hh343259.aspx) and [Storage Analytics Metrics Table Schema](http://msdn.microsoft.com/zh-cn/library/azure/hh343264.aspx).
...
You can find more information at [What is Application Insights?](/documentation/articles/app-insights-overview/).
