...
###<a id="entity-group-transactions"></a> Entity Group Transactions
...
For more information, see [Understanding the Table Service Data Model](http://msdn.microsoft.com/zh-cn/library/azure/dd179338.aspx).  
...
For information about encrypting table data, see [Client-Side Encryption and Azure Key Vault for Azure Storage](./storage-client-side-encryption.md).  
...
$filter=(PartitionKey eq 'Sales') and (RowKey ge 'email_a') and (RowKey lt 'email_b')  
 ...
 Note that the filter syntax used in the examples above is from the Table service REST API, for more information see [Query Entities](http://msdn.microsoft.com/zh-cn/library/azure/dd179421.aspx).  
