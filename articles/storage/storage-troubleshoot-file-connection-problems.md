...
For clients who are running Windows 8.1 or Windows Server 2012 R2, make sure that the hotfix [KB3114025](https://support.microsoft.com/zh-cn/kb/3114025) is installed. This hotfix improves the create and close handle performance.
...
For more information, see the [LmCompatibilityLevel](https://technet.microsoft.com/zh-cn/library/cc960646.aspx) topic on TechNet.
...
### Solution
Mount the share from a non-administrator command line. Alternatively, you can follow [this TechNet topic](https://technet.microsoft.com/zh-cn/library/ee844140.aspx) to configure the **EnableLinkedConnections** registry value.
