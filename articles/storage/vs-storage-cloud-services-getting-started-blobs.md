---
title: Get started with blob storage and Visual Studio connected services (cloud services) | Azure
...
- For general information about Azure Storage,see [Storage documentation](./index.md).
- For general information about Azure Cloud Services, see [Cloud Services documentation](../cloud-services/index.md).
...
> [!NOTE]
> Some APIs that perform calls out to Azure storage in ASP.NET are asynchronous. See [Asynchronous programming with Async and Await](http://msdn.microsoft.com/zh-cn/library/hh191443.aspx) for more information. The code in the following example assumes that you are using async programming methods.
...
For more information, see [CloudBlobContainer.ListBlobs](https://msdn.microsoft.com/zh-cn/library/azure/dd135734.aspx).
