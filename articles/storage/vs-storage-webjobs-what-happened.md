---
title: What happened to my WebJob project (Visual Studio Azure Storage connected service)? | Azure
...
For more information, see [Azure WebJobs documentation resources](../app-service-web/websites-webjobs-resources.md).