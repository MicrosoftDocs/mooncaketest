...
1. In the Azure portal click **Inputs** and then click **Add an Input** in your Stream Analytics job.
    ...
    In the Azure portal preview click the **Inputs** tile in your Stream Analytics job.  

    ![Azure portal preview - Add data input.](./media/stream-analytics-add-inputs/7-stream-analytics-add-inputs.png)  
