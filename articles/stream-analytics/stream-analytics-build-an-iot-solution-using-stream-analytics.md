...
尽管本教程提供详细的简介，但它绝对不是完整的说明。有关使用 SAQL 语言的更多查询模式，可在[常用流分析使用模式的查询示例](./stream-analytics-stream-analytics-query-patterns.md)中找到。若要了解有关 Azure 流分析的详细信息，请参阅[联机文档](./index.md)。
