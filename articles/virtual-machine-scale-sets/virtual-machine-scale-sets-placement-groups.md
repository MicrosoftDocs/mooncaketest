...
When you create a scale set in the Azure portal preview, you can allow it to scale to multiple placement groups by setting the _Limit to a single placement group_ option to _False_ in the _Basics_ blade. With this option set to _False_, you can specify an _Instance count_ value of up to 1,000.
