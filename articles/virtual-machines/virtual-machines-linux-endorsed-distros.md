---
title: Endorsed distributions of Linux | Azure
...
| SUSE Linux Enterprise |SLES/SLES for SAP<br>11 SP4<br>12 SP1+|In Kernel |Package:<p> for 11 in [Cloud:Tools](https://build.opensuse.org/project/show/Cloud:Tools) repo<br>for 12 included in "Public Cloud" Module under "python-azure-agent"<br/>Source Code: [GitHub](https://github.com/windows-azure/walinuxagent) |
