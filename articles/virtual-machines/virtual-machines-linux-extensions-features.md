...
若要浏览在端到端应用程序部署中使用 VM 扩展的示例，请参阅[将应用程序自动部署到 Azure 虚拟机](./virtual-machines-linux-dotnet-core-1-landing.md)。
...
有关支持的操作系统和安装说明的信息，请参阅 [Azure 虚拟机代理](./virtual-machines-linux-classic-agents-and-extensions.md)。
