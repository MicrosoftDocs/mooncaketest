...
1. Click the virtual machine. The VM can be found on the home screen of the Azure portal preview, or by selecting **Virtual Machines** from the left-hand menu.
