...
2. Review the default settings, update as necessary, and then click **OK**.
   ...
   ![Review disk settings](./media/virtual-machines-windows-classic-attach-disk/attach-new.png)
...
3. Under **Storage accounts**, select the account and container that holds the .vhd file.
   ...
   ![Find VHD location](./media/virtual-machines-windows-classic-attach-disk/existdiskstorageaccountandcontainer.png)
