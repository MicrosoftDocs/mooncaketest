---
title: Create an SAP multi-SID configuration in Azure | Azure
...
After the script has run, the results are displayed in the Azure portal preview, as shown in the following screenshot:

![New front-end IP pool in the Azure portal preview][sap-ha-guide-figure-6005]
