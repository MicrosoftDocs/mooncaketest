---
title: How to create NSGs in classic mode using the Azure CLI| Azure
...
This article covers the classic deployment model. You can also [create NSGs in the Resource Manager deployment model](virtual-networks-create-nsg-arm-cli.md).
