---
title: Azure Virtual Networks | Azure
...
* **Name resolution**. Azure provides [internal name resolution](virtual-networks-name-resolution-for-vms-and-role-instances.md) for IaaS VMs and PaaS role instances deployed in your VNet. You can also deploy your own DNS servers and configure the VNet to use them.
...
## Pricing
There is no extra cost for using Virtual Networks in Azure. The compute instances launched within the Vnet will be charged the standard rates as described in [Azure VM Pricing](https://www.azure.cn/pricing/details/virtual-machines/). The [VPN Gateways](https://www.azure.cn/pricing/details/vpn-gateway/) and [Public IP Addresses](https://www.azure.cn/pricing/details/reserved-ip-addresses/) used in the VNet will also be charged standard rates.
