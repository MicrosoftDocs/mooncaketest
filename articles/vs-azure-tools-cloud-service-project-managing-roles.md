---
title: Managing roles in Azure Cloud Service projects with Visual Studio | Azure
description: Learn how to add and remove roles in Azure Cloud Service projects with Visual Studio.
...
# Managing roles in Azure Cloud Service projects with Visual Studio
...
## Adding a role to an Azure Cloud Service project
...
## Removing a role from an Azure Cloud Service project
