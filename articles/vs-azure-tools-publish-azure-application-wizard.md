---
title: Publish Azure Application Wizard | Azure
...
1. Get a Microsoft account and an Azure subscription. You can try a free one month Azure subscription [here](https://www.azure.cn/pricing/1rmb-trial/)
2. Create a cloud service and a storage account on Azure. You can do this from Server Explorer in Visual Studio, or by using the [Azure Classic Management Portal](https://manage.windowsazure.cn).
...
4. After the cloud service project is added to your solution, open the same shortcut menu again and then choose **Publish**. For more information about how to enable applications for Azure, see [How to: Migrate and Publish a Web Application to an Azure Cloud Service from Visual Studio](https://msdn.microsoft.com/zh-cn/library/azure/hh420322.aspx).
