---
title: Using the Visual Studio Publish Azure Application Wizard | Azure
...
**Enable Web Deploy for all web roles** - Check this option, to enable web deployment for the service. You must select the **Enable Remote Desktop for all roles** option to use this feature. For more information, see [[Publishing a Azure Cloud Service using Visual Studio](https://msdn.microsoft.com/zh-cn/library/azure/ff683672.aspx)](https://msdn.microsoft.com/zh-cn/library/azure/ff683672.aspx). 
