...
The [Azure IoT Hub](/documentation/articles/iot-hub/iot-hub-what-is-iot-hub/) within the [IoT Suite](/documentation/articles/iot-suite/iot-suite-what-is-azure-iot/) offers a fully-managed service that enables reliable and secure bi-directional communication between IoT devices and Azure services such as [Azure Machine Learning](/documentation/articles/machine-learning/machine-learning-what-is-machine-learning/) and [Azure Stream Analytics](/documentation/articles/stream-analytics/stream-analytics-introduction/) by using per-device security credentials and access control.  
...
All keys used by the IoT infrastructure are stored in the cloud in secure storage, with the ability to roll over in case keys need to be re-provisioned. Data can be stored in [DocumentDB](/documentation/articles/documentdb/documentdb-introduction/) or in [SQL databases](/documentation/articles/sql-database/sql-database-faq/), enabling definition of the level of security desired. Additionally, Azure provides a way to monitor and audit all access to your data to alert you of any intrusion or unauthorized access.
